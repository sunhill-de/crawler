...
class HandlerHashTest extends SunhillScenarioTestCase
{
    ...
    public function testScanNewFile()
    {
        ...
        $this->assertEquals("ae4f281df5a5d0ff3cad6371f76d5c29b6d953ec",$descriptor->fileinfo->hash);
    }
    ...
    public function testScanKnownFile()
    {
        ...
        $this->assertEquals("6dcd4ce23d88e2ee9568ba546c007c63d9131c1b",$descriptor->fileinfo->hash);
